...
function init() {
  ...
  document.querySelectorAll('#presidium-content img').forEach(function (img) {
...
/* harmony export */   "loadTooltips": () => (/* binding */ loadTooltips)
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _util_articles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../util/articles */ "./src/util/articles.js");
...
function tooltipError(error, terms) {
  ...
  terms.forEach(function (term) {
    console.log("[presidium-js] Could not create the tooltip: ".concat(term.innerText));
 ...
 * @param url {string}
 */
function addToDom(term, content, url) {
...
function createTooltip(term, page, url) {
  ...
  var match = parser.parseFromString(page, 'text/html').querySelector("span.anchor[id='".concat(title, "']"));
  if (match) {
    try {
    ...
    tooltipError("Term: ".concat(title, ", has no match."), [term]);
  }
}
...
function loadTooltips() {
  ...
  var glossaryTerms = document.querySelectorAll("a[title=presidium-tooltip][href='".concat('#', "']"));
  var linkTerms = document.querySelectorAll("a[title=presidium-tooltip][href^='".concat('/', "']"));
  if (glossaryTerms.length > 0) {
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("".concat(config.baseurl, "/glossary/")).then(function (response) {
      glossaryTerms.forEach(function (term) {
        var url = "".concat(config.baseurl, "/glossary/#").concat((0,_util_articles__WEBPACK_IMPORTED_MODULE_1__.slugify)(term.innerText));
  ...
  linkTerms.forEach(function (term) {
  ...
  var Constructor = function Constructor(selector, options) {
    ...
    publicAPIs.setup = function () {
      ...
      Array.prototype.forEach.call(navItems, function (item) {
        ...
        var target = item.getAttribute(options.attribute);
        var id = decodeURIComponent(target.substr(1));
...
if (typeof process !== 'undefined' && ({"PRESIDIUM_HOST":"undefined"}) && "development" === 'test') {}
...
/* harmony import */ var _components_image_modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/image/modal */ "./src/components/image/modal.js");
/* harmony import */ var _components_tooltips_tooltips__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/tooltips/tooltips */ "./src/components/tooltips/tooltips.js");
/* harmony import */ var _util_articles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./util/articles */ "./src/util/articles.js");
/* harmony import */ var rxjs_Subject__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/Subject */ "./node_modules/rxjs/Subject.js");
...
/* harmony import */ var _util_scroll_spy__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./util/scroll-spy */ "./src/util/scroll-spy.js");
/* harmony import */ var _util_scroll_spy__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_util_scroll_spy__WEBPACK_IMPORTED_MODULE_6__);
...
(0,_components_image_modal__WEBPACK_IMPORTED_MODULE_1__.init)();
...
var presidium = {
  tooltips: {
    load: _components_tooltips_tooltips__WEBPACK_IMPORTED_MODULE_2__.loadTooltips
  },
  modal: {
    init: _components_image_modal__WEBPACK_IMPORTED_MODULE_1__.init
  },
  versions: {}
};
window.presidium = presidium;
window.events = new rxjs_Subject__WEBPACK_IMPORTED_MODULE_4__.Subject();

// Role filtering
jquery__WEBPACK_IMPORTED_MODULE_5___default()(function () {
  var cachedRole = sessionStorage.getItem('role');
  var filterArticles = function filterArticles(selectedRole) {
    sessionStorage.setItem('role', selectedRole);
    jquery__WEBPACK_IMPORTED_MODULE_5___default()('.article').show();
    jquery__WEBPACK_IMPORTED_MODULE_5___default()('#presidium-navigation .menu-row').removeClass('hidden').show();
    if (selectedRole != 'All Roles') {
      var $articles = jquery__WEBPACK_IMPORTED_MODULE_5___default()('.article:not([data-roles="All Roles"])');
      var $navSectionLinks = jquery__WEBPACK_IMPORTED_MODULE_5___default()('#presidium-navigation .menu-row:not([data-roles="All Roles"])');
      $articles.each(function (i, article) {
        if (!jquery__WEBPACK_IMPORTED_MODULE_5___default()(article).data('roles').includes(selectedRole)) {
          jquery__WEBPACK_IMPORTED_MODULE_5___default()(article).hide();
        }
      });
      $navSectionLinks.each(function (i, link) {
        if (!jquery__WEBPACK_IMPORTED_MODULE_5___default()(link).data('roles').includes(selectedRole)) {
          jquery__WEBPACK_IMPORTED_MODULE_5___default()(link).hide();
        }
      });
    }
  };
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('#roles-select').on('change', function (e) {
    var optionSelected = jquery__WEBPACK_IMPORTED_MODULE_5___default()('option:selected', this);
    var selectedRole = this.value;
    filterArticles(selectedRole);
  });
  if (cachedRole && jquery__WEBPACK_IMPORTED_MODULE_5___default()('#roles-select option:selected').text() !== cachedRole) {
    // When a page reloads occurs from navigating to a new section
    // reload the selected role and trigger the filter
    jquery__WEBPACK_IMPORTED_MODULE_5___default()('#roles-select').val(cachedRole);
    jquery__WEBPACK_IMPORTED_MODULE_5___default()('#roles-select').trigger('change');
  }
});
var offset = 0;
var content = jquery__WEBPACK_IMPORTED_MODULE_5___default()('.article-title').get(0);
if (content) {
  offset = window.pageYOffset + content.getBoundingClientRect().top;
}
var spy = new (_util_scroll_spy__WEBPACK_IMPORTED_MODULE_6___default())('.navbar-items ul a', {
...
/******/ })()
;
//# sourceMappingURL=presidium.js.map